		...
		public function require() {
			$required = apply_filters(
				...
				array(
					...
					'class.yith-wcan-cron.php',
					'class.yith-wcan-admin.php',
					'class.yith-wcan-frontend.php',
					'class.yith-wcan-filter.php',
					'class.yith-wcan-session.php',
					'class.yith-wcan-session-factory.php',
					...
					'data-stores/class.yith-wcan-session-data-store.php',
					'widgets/class.yith-wcan-navigation-widget.php',
					'widgets/class.yith-wcan-reset-navigation-widget.php',
					'widgets/class.yith-wcan-filters-widget.php',
					'shortcodes/class.yith-wcan-shortcode-filters.php',
					'shortcodes/class.yith-wcan-shortcode-active-filters-labels.php',
					'shortcodes/class.yith-wcan-shortcode-reset-button.php',
					'shortcodes/class.yith-wcan-shortcode-mobile-modal-opener.php',
				)
			);
