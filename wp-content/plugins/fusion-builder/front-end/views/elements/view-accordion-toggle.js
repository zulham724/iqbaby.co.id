	...
	jQuery( document ).ready( function() {
		...
		FusionPageBuilder.fusion_toggle = FusionPageBuilder.ChildElementView.extend( {
			...
			filterTemplateAtts: function( atts ) {
				...
				attributes.activeIcon                = '' !== parentValues.active_icon ? parentValues.active_icon : 'awb-icon-plus';
				attributes.inActiveIcon              = '' !== parentValues.inactive_icon ? parentValues.inactive_icon : 'awb-icon-minus';
