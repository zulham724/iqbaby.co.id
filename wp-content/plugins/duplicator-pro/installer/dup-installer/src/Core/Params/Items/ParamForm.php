    ...
    protected function selectHtml()
    {
        ...
        <select <?php echo \DUPX_U_Html::arrayAttrToHtml($attrs); ?> >
            ...
            foreach ($this->getOptions() as $option) {
                ...
                } elseif ($this->isValueInValue($option->value)) {
    ...
    protected static function getDefaultAttrForFormType($formType)
    {
        ...
        switch ($formType) {
            ...
            case self::FORM_TYPE_TEXT:
                ...
                $attrs['size']                  = null;
                $attrs['prefix']                = array('type' => 'none', 'label' => null, 'id' => null, 'btnAction' => null, 'attrs' => array()); // none | button | label
                $attrs['postfix']               = array('type' => 'none', 'label' => null, 'id' => null, 'btnAction' => null, 'attrs' => array()); // none | button | label
                break;
            case self::FORM_TYPE_SELECT:
