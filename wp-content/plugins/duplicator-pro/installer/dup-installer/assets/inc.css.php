...
<style>
    ...
    *:focus {
    ...
    #wrapper_item_cont_owner.param-wrapper-disabled,
    #wrapper_item_keep_users.param-wrapper-disabled {
        display: none;
    }
    ...
    #wrapper_item_install-type input[value="4"] + .label-checkbox::after,
    #wrapper_item_install-type input[value="5"] + .label-checkbox::after,
    ...
    #installer-switch-wrapper  {text-align:right}
    ...
    div.s2-tables-checkall {padding:5px 30px 0 0; margin:0}
    ...
    table.list_table_selector td {
        padding: 10px 5px;
        line-height: 1.5em;
    }

    table.list_table_selector .check_input {
        text-align: center;
    }

    table.list_table_selector .check_input input {
        margin: 0;
    }

    table.list_table_selector th.name {
        text-align:left;
    }

    table.list_table_selector th.info {
        text-align:left;
    }
    ...
    td.list_table_selector .orig_status {
        text-align: center;
    }
    ...
    table.list-import-upt-tables {border-collapse:collapse}
    table.list-import-upt-tables {width:100%; display:block;}
    table.list-import-upt-tables thead {display:inline-block; width:100%;}
    table.list-import-upt-tables tbody {height:700px; display:inline-block; width:100%; overflow-y: auto;}
    table.list-import-upt-tables th.name, table.list-import-upt-table th.info  {width:40%;}
    table.list-import-upt-tables td.name, table.list-import-upt-table td.info  {width:40%;}
    table.list-import-upt-tables th.name  {padding-right:0}
    table.list-import-upt-tables th.info  {padding-left:0}
    table.list-import-upt-tables td  {padding-top:6px; padding-bottom:6px}
    table.list-import-upt-tables th.action, table.list-import-upt-tables td.action  {width:10%}
    table.list-import-upt-tables td.spacer, table.list-import-upt-tables th.spacer {width:15px; padding:0}
    table#list-import-upt-tables-chk-all tbody{height:100%;}
    table.list-import-upt-tables th {border-collapse:collapse;}
