...
class DUPX_InstallerState
{
    ...
    /**
     * Return true if current install overwrite asite in multisite
     *
     * @param int $type type of installation, if nulle get current param
     *
     * @return boolean
     */
    public static function isOverwriteSiteOnMultisite($type = null)
    {
        return (self::isAddSiteOnMultisite() && PrmMng::getInstance()->getValue(PrmMng::PARAM_SUBSITE_OVERWRITE_ID) > 0);
    }
    ...
    public static function getAdminLogin()
    {
        ...
        if (self::isAddSiteOnMultisite()) {
            ...
            $adminUrl = $paramsManager->getValue(PrmMng::PARAM_SITE_URL);
        }
