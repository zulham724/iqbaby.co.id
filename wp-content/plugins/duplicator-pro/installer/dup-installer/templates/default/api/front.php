                            ...
                            <td>
                                ...
                                <?php foreach ($apiControllers as $class) : ?>
                                    <div style="padding: 5px 0 5px 0;">
                                        ...
                                        ?>
                                        <a href="javascript:void(0)" onclick="$('#frm-<?php echo DUPX_U::esc_js($id); ?>').toggle()" class="operation">&#xbb;<?php echo DUPX_U::esc_html($name); ?></a><br/>
                                        ...
                                        <form id="frm-<?php echo $id ?>" class="api-form" autocomplete="off" >
                                            ...
                                            <a href="javascript:void(0)" onclick="RequestAPI($('#txt-<?php echo DUPX_U::esc_js($id); ?>').val(), 0)">[Test]</a> &nbsp;
                                            <a href="javascript:void(0)" onclick="RequestAPI($('#txt-<?php echo DUPX_U::esc_js($id); ?>').val(), 1)">[New Window]</a> &nbsp;
