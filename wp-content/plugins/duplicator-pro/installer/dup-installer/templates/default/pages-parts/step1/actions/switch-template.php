...
<div id="installer-switch-wrapper">
    <span class="btn-group small">
        <button type="button" id="s1-switch-template-btn-basic" class="s1-switch-template-btn" data-template="<?php echo DUPX_Template::TEMPLATE_BASE; ?>"  title="Enable basic installer mode">
            Basic
        </button>
