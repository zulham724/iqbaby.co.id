...
<tr>
    ...
    <td>
        ...
        Overwrite only the tables that are extracted. This option is useful if you want to install WordPress in a database containing other WordPress installations or applications.<br>
        <span style="font-style:italic">Note:</span> When performing an install alongside another installation be sure to change the prefix since only those tables with the same prefix be overwritten while tables of a different prefix will be retained.
        <br/>
        <br/>
        ...
        <b>Backup and Rename Existing Tables:</b><sup>pro</sup><br/>
