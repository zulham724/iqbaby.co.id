...
<p>
    PHP extensions are compiled libraries which enable specific functions to be used in your PHP code. This test checks if some of the most widely used extensions are
