...
<p class="<?php echo $statusClass; ?>">
    <?php if ($isOk) { ?>
        The user <b>[<?php echo htmlentities($dbuser); ?>]</b> successfully connected to the database server on host <b>[<?php echo htmlentities($dbhost); ?>]</b>.
    <?php } else { ?>
        Unable to connect the user <b>[<?php echo htmlentities($dbuser); ?>]</b> to the host <b>[<?php echo htmlentities($dbhost); ?>]</b>.<br>
        <?php if ($mysqlConnErr) { ?>
