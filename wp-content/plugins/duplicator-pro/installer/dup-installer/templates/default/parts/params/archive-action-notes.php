...
?>
<div class="dynamic-sub-note dynamic-sub-note-<?php echo DUP_PRO_Extraction::ACTION_DO_NOTHING . ($currentAction == DUP_PRO_Extraction::ACTION_DO_NOTHING ? '' : ' no-display'); ?>">
...
<div class="dynamic-sub-note dynamic-sub-note-<?php echo DUP_PRO_Extraction::ACTION_REMOVE_ALL_FILES . ($currentAction == DUP_PRO_Extraction::ACTION_REMOVE_ALL_FILES ? '' : ' no-display'); ?>">
...
<div class="dynamic-sub-note dynamic-sub-note-<?php echo DUP_PRO_Extraction::ACTION_REMOVE_UPLOADS . ($currentAction == DUP_PRO_Extraction::ACTION_REMOVE_UPLOADS ? '' : ' no-display'); ?>">
...
<div class="dynamic-sub-note dynamic-sub-note-<?php echo DUP_PRO_Extraction::ACTION_REMOVE_WP_FILES . ($currentAction == DUP_PRO_Extraction::ACTION_REMOVE_WP_FILES ? '' : ' no-display'); ?>">
