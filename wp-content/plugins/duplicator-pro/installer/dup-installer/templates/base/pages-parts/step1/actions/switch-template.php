...
<div id="installer-switch-wrapper">
    <span class="btn-group small">
        ...
        <button type="button" id="s1-switch-template-btn-advanced" class="s1-switch-template-btn" data-template="<?php echo DUPX_Template::TEMPLATE_ADVANCED; ?>" title="Enable advanced installer mode">
            Advanced
        </button>
    </span>
</div>