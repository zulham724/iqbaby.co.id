...
class DUP_PRO_Global_Entity extends DUP_PRO_JSON_Entity_Base
{
    ...
    public function set_from_data($global_data)
    {
        ...
        $this->betaMUimport = $global_data->betaMUimport;
    }
...
//        }
    ...
    {
        //DATABASE
        $dbMode                = is_null($dbMode) ? filter_input(
            INPUT_POST,
            '_package_dbmode',
        ...
        $packageMysqldumpPath = is_null($packageMysqldumpPath) ? filter_input(
            INPUT_POST,
            '_package_mysqldump_path',
            FILTER_DEFAULT,
            array('options' => array(
                        'default' => ''
                                                                              ))
     ...
     * @return bool
     */
    public function isMuImportEnabled()
    {
        return (is_multisite() && $this->betaMUimport);
    }
}