...
class Requirements implements \Duplicator\Core\RequirementsInterface
{
    ...
    public static function canRun($pluginFile)
    {
        ...
        if (self::isPluginActive(self::DUP_LITE_PLUGIN_KEY)) {
            ...
            self::$deactivationMessage = __('Can\'t enable Duplicator PRO if the LITE version is enabled.', 'duplicator-pro') . '<br/>'
                  . __('Please deactivate Duplicator LITE, then reactivate PRO version from the ', 'duplicator-pro')
