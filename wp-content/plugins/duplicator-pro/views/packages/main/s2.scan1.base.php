...
<style>
    ...
    div.scan-item div.badge {float:right; border-radius:2px; color:#fff; min-width:40px; text-align:center; position:relative; right:10px; font-size:12px; padding:0 3px 0 3px}
