        ...
        <div class="dup-box-panel">
            ...
            <div class='dup-sys-req'>
                ...
                <div class="dup-sys-info dup-info-box">
                    ...
                    <small>
                        <?php DUP_PRO_U::esc_html_e("MySQL version 5.0+ or better is required.  Contact your server administrator and request MySQL Server 5.0+ be installed."); ?>
                    </small>
                    <hr>
                    <table class="dup-sys-info-results">
                        <tr>
                    ...
                    <small>
                        <?php DUP_PRO_U::esc_html_e("The function mysqli_real_escape_string is not working properly. Please consult host support and ask them to switch to a different PHP version or configuration."); ?>
                    </small>
                </div>
            </div>
            ...
            <div class="dup-sys-contact">
                <?php
                printf(
                    "<i class='fa fa-question-circle'></i> %s <a href='admin.php?page=duplicator-pro-tools&tab=support'>[%s]</a>",
