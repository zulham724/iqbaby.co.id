...
<!-- ===============================
ADVANCED SETTINGS -->
<form id="dup-settings-form" action="<?php echo Duplicator\Core\Controllers\ControllersManager::getCurrentLink(); ?>" method="post" data-parsley-validate>
    ...
    <table class="form-table">
        ...
        <tr valign="top">
            ...
            <td>
                <input type="checkbox" name="homepath_as_abspath" id="homepath_as_abspath" <?php echo disabled(DUP_PRO_Archive::isAbspathHomepathEquivalent()); ?> <?php echo checked($global->homepath_as_abspath); ?> value="1" >
                ...
                <p class="description">
                    ...
                    if (DUP_PRO_Archive::isAbspathHomepathEquivalent()) {
                        ...
                        ?>
                        <?php printf(DUP_PRO_U::__('In this installation the default root path is <b>%s</b>.'), esc_html(SnapIO::safePathUntrailingslashit(get_home_path(), true))); ?><br>
                        <?php
                        DUP_PRO_U::esc_html_e('The path of the wordpress core is different. Activate this option if you want to consider ABSPATH as root path.');
                    }
                    ?>
        ...
        <tr valign="top">
            ...
            <td>
                ...
                <p class="description">
                    <?php
                    DUP_PRO_U::esc_html_e('If enabled all files check on scan will be skipped before package creation. In some cases, this option can be beneficial if the '
