...
if ($displayCopyLink) {
        ...
        <i class="fas fa-question-circle fa-sm"
           ...
           data-tooltip="<?php
            DUP_PRO_U::esc_attr_e(
                'The recovery point URL is the link to the recovery point package installer.  The link will run the installer wizard used to re-install and recover the site.  '
                . 'Copy this link and keep it in a safe location to easily restore this site.'
            );
                         echo esc_attr('<br><br><b>');
                         DUP_PRO_U::esc_attr_e('This URL is valid until another recovery point is set.');
                         echo esc_attr('</b>');
                            ?>"></i> 
    ...
    <div class="copy-link <?php echo $disabledClass; ?>"  
         data-dup-pro-copy-value="<?php echo esc_url($installerLink); ?>"
...
<div class="dup-pro-recovery-buttons" >
    ...
    if ($displayDownload && isset($downloadLauncherData)) {
        ?>
    ...
    if ($displayCopyButton) {
        ?>
        <button type="button" class="button button-primary dup-pro-recovery-download-launcher <?php echo $disabledClass; ?>" 
                data-dup-pro-copy-value="<?php echo $installerLink; ?>"
                data-dup-pro-copy-title="<?php DUP_PRO_U::_e("Copy Recovery URL to clipboard"); ?>"
                data-dup-pro-copied-title="<?php DUP_PRO_U::_e("Recovery URL copied to clipboard"); ?>" >
