...
<form id="dup-package-form" action="<?php echo esc_url($templates_tab_url); ?>" method="post">
    ...
    <!-- ====================
    LIST ALL SCHEDULES -->
    <table class="widefat template-tbl striped">
        <thead>
            <tr>
                <th class="dup-col-check" ><input type="checkbox" id="dpro-chk-all" title="Select all packages" onclick="DupPro.Template.SetDeleteAll(this)"></th>
                <th class="dup-col-name" ><?php _e('Name', 'duplicator-pro'); ?></th>
