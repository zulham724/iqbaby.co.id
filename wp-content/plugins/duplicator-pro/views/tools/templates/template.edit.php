...
<div class="margin-bottom-1">
    <b><?php _e("Recovery Status", 'duplicator-pro'); ?>:</b> &nbsp; <?php $package_template->recoveableHtmlInfo(); ?>
</div>
<div class="dpro-template-general">
    <label class="lbl-larger"><?php _e("Template", 'duplicator-pro'); ?>:</label>
    ...
    <label class="lbl-larger"><?php _e("Notes", 'duplicator-pro'); ?>:</label> <br/>
...
<div class="dup-box-panel" id="dup-template-archive-panel" style="<?php echo esc_attr($ui_css_archive); ?>">
    ...
    <!-- =================
    FILES -->
    <b class="dpro-hdr"><i class="far fa-file"></i> <?php DUP_PRO_U::esc_html_e('FILES'); ?></b>

    <div class="dup-form-item">
        <span class="title"><?php DUP_PRO_U::esc_html_e("Database") ?>:</span>
        <span class="input">
    ...
    <div class="dup-form-item">
        <span class="title"><?php DUP_PRO_U::esc_html_e("File Filters") ?>:</span>
        <span class="input">
            ...
            <label for="archive_filter_on"><?php _e("Enable File &amp; Folder Filters"); ?></label>
        </span>
    </div>
    ...
    <div id="dup-exportdb-items-off">
        <div class="dup-form-item">
            ...
            <div class='dup-quick-links'>
                ...
                <a href="javascript:void(0)" onclick="DupPro.Template.AddExcludePath('<?php echo SnapIO::safePath(WP_CONTENT_DIR); ?>/cache')">[<?php DUP_PRO_U::esc_html_e("cache") ?>]</a>
    ...
    <div class="dup-template-db-area">
        ...
        <?php if (false && is_multisite() && \Duplicator\Addons\ProBase\License\License::isBusiness()) : ?>
            <!-- ===================
             MULTI-SITE:  -->
    ...
    jQuery(document).ready(function ($) {
        ...
        DupPro.Template.EnableInstallerPassword = function ()
        {
            ...
            if ($('#_installer_opts_secure_on').is(':checked')) {
                $('#_installer_opts_secure_pass').prop('readonly', false);
                $('#_installer_opts_secure_pass').prop('required', true).focus();
                $('#dpro-install-secure-lock').show();
                $('#dpro-install-secure-unlock').hide();
                $button.prop('disabled', false);
            } else {
                $('#_installer_opts_secure_pass').prop('required', false);
                $('#_installer_opts_secure_pass').prop('readonly', true);
