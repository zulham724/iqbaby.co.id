...
define('DUPLICATOR_PRO_VERSION', '4.0.4.1');
...
define('DUPLICATOR_PRO_PLUGIN_PATH', dirname(__FILE__));
...
define('DUPLICATOR_PRO_LOCKING_FILE_FILENAME', DUPLICATOR_PRO_PLUGIN_PATH . '/dup_pro_lock.bin');
