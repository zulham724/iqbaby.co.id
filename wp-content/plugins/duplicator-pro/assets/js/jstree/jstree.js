...
/*jshint -W083 */
    ...
    $.jstree.reference = function (needle) {
        ...
        if (!obj || !obj.length) {
            try {
                obj = $(needle); } catch (ignore) {
                }
        }
        if (!obj || !obj.length) {
            try {
                obj = $('#' + needle.replace($.jstree.idregex,'\\$&')); } catch (ignore) {
                }
        }
    ...
    $.jstree.core.prototype = {
                ...
                try {
                    ...
                    if (!this._data.core.working || force_processing) {
                        ...
                        w.onmessage = $.proxy(function (e) {
                            ...
                            try {
                                w.terminate(); w = null; } catch (ignore) {
                                }
        ...
        get_selected : function (full) {
            return full ? $.map(this._data.core.selected, $.proxy(function (i) {
                return this.get_node(i); }, this)) : this._data.core.selected.slice();
        },
        /**
        ...
        get_top_selected : function (full) {
            ...
            return full ? $.map(tmp, $.proxy(function (i) {
                return this.get_node(i); }, this)) : tmp;
        },
        /**
        ...
        get_bottom_selected : function (full) {
            ...
            return full ? $.map(obj, $.proxy(function (i) {
                return this.get_node(i); }, this)) : obj;
        },
        /**
    ...
    $.jstree.plugins.checkbox = function (options, parent) {
        ...
        this.get_checked = function (full) {
            ...
            return full ? $.map(this._data.checkbox.selected, $.proxy(function (i) {
                return this.get_node(i); }, this)) : this._data.checkbox.selected;
        };
        /**
                    ...
                    if ($.vakata.context.settings.icons) {
                        ...
                        if (val.icon) {
                            if (val.icon.indexOf("/") !== -1 || val.icon.indexOf(".") !== -1) {
                                str += " style='background:url(\"" + val.icon + "\") center center no-repeat' "; } else {
                                str += " class='" + val.icon + "' "; }
                        }
                                ...
                                if (v === 'i' && ref.parent().is('.jstree-closed') && ins.settings.dnd.open_timeout) {
                                    if (!data.event || data.event.type !== 'dragover' || isDifferentNode) {
                                        ...
                                        opento = setTimeout((function (x, z) {
                                            return function () {
                                                x.open_node(z); }; }(ins, ref)), ins.settings.dnd.open_timeout);
                                    }
                                }
                                if (ok) {
            ...
            if (r.length) {
                ...
                if (!append) {
                    this._data.search.dom = $(this.element[0].querySelectorAll('#' + $.map(r, function (v) {
                        return "0123456789".indexOf(v[0]) !== -1 ? '\\3' + v[0] + ' ' + v.substr(1).replace($.jstree.idregex,'\\$&') : v.replace($.jstree.idregex,'\\$&'); }).join(', #')));
